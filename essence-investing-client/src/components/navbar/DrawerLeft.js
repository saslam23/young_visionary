  ...
  return (
    ...
    {['left'].map((anchor) => (
      <React.Fragment key={anchor}>
        ...
        >
           <Link  hashSpy={true} smooth={true} offset={-120} to="young-visionary"><img  style={{height:'100px', width:'100px', marginLeft:'1rem', marginTop:'1rem'}} src="/assets/young_visionary_logo.svg" alt="logo"/></Link>
             {pages.map((page) => (
